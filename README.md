...
This project is a re-digitization of *Magic Castle*, a previously unreleased game for the ATARI 800 8-bit home computer, designed and programmed by Bruce May around 1983. The source files are based on the scanned artifacts found at [archive.org](https://archive.org/details/magiccastle_atari). An interview with Bruce May regarding the development and eventual fate of *Magic Castle* was recorded for [ANTIC - The ATARI 8-bit Podcast Interview Episode 375](https://ataripodcast.libsyn.com/antic-interview-375-bruce-may-unreleased-magic-castle-game). 

## Goal
The goal of this endevour is been to re-implement the game code and binary data exactly as found in the assets available. However it is possible the code listings were created prior to the final version. I say this because the documentation and programming notes mention three levels of the Void, however the data dump contains data for only one and the code does not appear to expect more than one.
